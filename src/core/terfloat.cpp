...
namespace termite {
    ...
    TerFloat TerFloat::operator%(const TerFloat& other) const {
        ...
        // // For some reason for exponent < 0 the result will be 1/3 the size it should be
        // // so quick fixing it like this
        //         if(exponent < Word::ZERO) {
        //     result.exponent = result.exponent + Word::ONE;
        // } 
        return result;
    }
